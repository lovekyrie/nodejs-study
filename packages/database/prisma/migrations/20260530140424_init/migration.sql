...
-- CreateIndex
CREATE INDEX "memberships_organizationId_roleId_idx" ON "memberships"("organizationId", "roleId");
...
-- CreateIndex
CREATE INDEX "projects_organizationId_deletedAt_createdAt_idx" ON "projects"("organizationId", "deletedAt", "createdAt");
